...
import app.models.custom_field_type.ip_field_type
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_ip', app.models.custom_field_type.ip_field_type.IPAddressField(max_length=39, null=True)),
                ('user_detail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_detail', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
